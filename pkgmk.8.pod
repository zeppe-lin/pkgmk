# pkgmk.8.pod - documentation for pkgmk(8) manual page
...
or .pkg.tar.xz) that can be installed using L<pkgadd(8)>.

To prepare to use B<pkgmk>, you must write a file named F<Pkgfile>,
that describes how the package should be build.  See L<Pkgfile(5)> for
more information how-to write Pkgfile files.  Once a suitable
...
Package build description.  See L<Pkgfile(5)> for more information.
...
Global package make configuration.  See L<pkgmk.conf(5)> for more
information.
